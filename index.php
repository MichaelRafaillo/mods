        ...
        <form action="./database/addneworder.php" method="POST">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="orderdate" class="form-control" id="inorderdate"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="inname" placeholder="Customer Name"
                        name="cname">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6" id="inputgroupss">
                    <input type="text" name="item1" class="form-control hey99" id="hey99" placeholder="1"
                        required>
                </div>
    ...
    <div class="container-fluid searchcontainer">
        <div class="row">
            <div class="col-md-4 col-sm-8">
                <input class="inputsearch" type="text" id="myInput" onkeyup="mysearchFunction()"
            ...
            <div class="col-md-2 col-sm-12">
                <button type="button" class="btn btn-success col-12" onclick="openbtn()"><i
                        class="bi bi-plus-lg"></i> Create New Order</button>
            </div>
            <form action="./index.php" method="POST" class="col-md-2 col-sm-6">
                <input type="month" onchange="this.form.submit()" name="selecteddate" class="inputsearch"
                    value="<?php echo $_SESSION['smonth']; ?>">
            ...
            <div class="row" style="width:100%;">
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card-body">
                        ...
                        <div class="float-end analysisicons"
                            style="font-size:15px;background-color:transparent;cursor:pointer;"
                            onclick="printExternal('./print-today.php')">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card-body">
                        ...
                        <div class="float-end analysisicons"
                            style="font-size:15px;background-color:transparent;cursor:pointer;"
                            onclick="printExternal('./print-curior.php')">
                            <i class="bi bi-printer-fill"></i>
                        </div>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card-body">
                        ...
                        <div class="float-end analysisicons"
                            style="font-size:15px;background-color:transparent;cursor:pointer;"
                            onclick="printExternal('./print-inbranches.php')">
                            <i class="bi bi-printer-fill"></i>
                        </div>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card-body">
                        ...
                        <div class="float-end analysisicons"
                            style="font-size:15px;background-color:transparent;cursor:pointer;"
                            onclick="printExternal('./print-pack.php')">
                            <i class="bi bi-printer-fill"></i>
                        </div>
        ...
        <div>
            <table class="table table-bordered table-dark" id="myTable">
                ...
                <tbody id="tbody row containerItems">
                    ...
                    <tr name="datarow" class="rowconfirmed" data-search="<?php echo $row['order_no']; ?>"
                        data-filter="<?php echo $row['order_no']; ?>">
                        ...
                        <th scope="row">
                            ...
                            </p><a href="<?php echo './edit-order.php?id=' . $row['order_no']; ?>" style="font-size:20px;color:#bdbdbd;"><i
                        ...
                        <td>
                            ...
                            <span id="confirmationbtns<?php echo $row['order_no']; ?>">
                                <button title="Confirmed" class="fulfil-btn"
                                    onclick="setconfirmed(<?php echo $row['order_no']; ?>)">
                                    <i class="bi bi-check-lg"></i>
                                </button>

                                <button title="No Answer" class="fulfil-btn"
                                    onclick="setnoanswer(<?php echo $row['order_no']; ?>)">
                                ...
                                <button title="Cancel" class="fulfil-btn"
                                    onclick="setcancelled(<?php echo $row['order_no']; ?>)">
                        ...
                        <td>
                            ...
                            <a target="_blank" class="d-inline-block float-right" title="Confirmation Message"
                                href="https://api.whatsapp.com/send?phone=<?php echo $customerContactNumber; ?>&text=<?php echo rawurlencode("
                            ...
                            <a target="_blank" class="d-inline-block float-right mr-2" title="Reschedule Message"
                                href="https://api.whatsapp.com/send?phone=<?php echo $customerContactNumber; ?>&text=<?php echo rawurlencode("
                                عزيزي/عزيزتي *$customerName*,
                            ...
                            <a target="_blank" class="d-inline-block float-right mr-2"
                                title="deliver to branch Message"
                                href="https://api.whatsapp.com/send?phone=<?php echo $customerContactNumber; ?>&text=<?php echo rawurlencode("
                                عزيزي / عزيزتي  *$customerName*،
                        ...
                        <td>
                            ...
                            <input type="date" name="orderdate" class="form-control ddate"
                                id="theddate<?php echo $row['order_no']; ?>" onchange="changeddate(<?php echo $row['order_no']; ?>)"
                                placeholder="Order Date" value="<?php echo $row['delivery_date']; ?>" format="dd-mm-yyyy">
                        ...
                        <td>
                            ...
                            <select class="form-select zonesselect" aria-label="Default select example"
                                id="thebranch<?php echo $row['order_no']; ?>" onchange="changebranch(<?php echo $row['order_no']; ?>)"
                                style="display:none;">
                                ...
                                <option value="City Center Alexandria" <?php if ($row['branch'] == 'City Center Alexandria') {
                                    echo 'selected';
                                } ?>>City Center Alexandria</option>
                            ...
                            <span id="statusbtns<?php echo $row['order_no']; ?>">
                                ...
                                <button title="Printed" class="fulfil-btn"
                                    onclick="setprinted(<?php echo $row['order_no']; ?>)"><i
                                        class="bi bi-printer-fill"></i></button>

                                <button title="Fulfilled" class="fulfil-btn"
                                    onclick="setfulfilled(<?php echo $row['order_no']; ?>)"><i class="bi bi-truck"></i></button>

                                <button title="Cash" class="fulfil-btn" onclick="setcash(<?php echo $row['order_no']; ?>)"><i
                                        class="bi bi-cash-coin"></i></button>

                                <button title="Visa" class="fulfil-btn" onclick="setvisa(<?php echo $row['order_no']; ?>)"><i
                                        class="bi bi-credit-card-2-front-fill"></i></button>

                                <button title="Cancel" class="fulfil-btn"
                                    onclick="setocancelled(<?php echo $row['order_no']; ?>)"><i
